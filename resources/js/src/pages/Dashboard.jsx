                        ...
                        <CardContent>
                            ...
                            <span
                                className={cn(
                                    ...
                                    kpi.trend === "up"
                                        ? kpi.name.includes("Bounce") ||
                                          kpi.name.includes("Unsubscribe")
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card className="bg-blue-50/50 dark:bg-blue-900/10 border-blue-100/50 dark:border-blue-900/30">
                    <CardContent className="flex items-center p-6 gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold uppercase tracking-wider text-blue-600/80 dark:text-blue-400/80">
                                Best Open Time
                            </p>
